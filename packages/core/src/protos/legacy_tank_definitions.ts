...
export const TankDefinition: MessageFns<TankDefinition> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          const entry2 = TankDefinition_RolesEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  fromJSON(object: any): TankDefinition {
    return {
      ...
      name_full: isSet(object.name_full)
        ? I18nString.fromJSON(object.name_full)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<TankDefinition>, I>>(
    ...
    message.name_full =
      object.name_full !== undefined && object.name_full !== null
