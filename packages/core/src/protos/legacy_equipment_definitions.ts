...
export const EquipmentDefinitions: MessageFns<EquipmentDefinitions> = {
  encode(
    ...
    Object.entries(message.presets).forEach(([key, value]) => {
      EquipmentDefinitions_PresetsEntry.encode(
        { key: key as any, value },
        writer.uint32(10).fork(),
      ).join();
    });
    Object.entries(message.equipments).forEach(([key, value]) => {
      EquipmentDefinitions_EquipmentsEntry.encode(
        { key: key as any, value },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = EquipmentDefinitions_PresetsEntry.decode(
            reader,
            reader.uint32(),
          );
        ...
        case 2: {
          ...
          const entry2 = EquipmentDefinitions_EquipmentsEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  fromJSON(object: any): EquipmentDefinitions {
    return {
      presets: isObject(object.presets)
        ? Object.entries(object.presets).reduce<{
      ...
      equipments: isObject(object.equipments)
        ? Object.entries(object.equipments).reduce<{
  ...
  create<I extends Exact<DeepPartial<EquipmentDefinitions>, I>>(
    base?: I,
  ): EquipmentDefinitions {
    return EquipmentDefinitions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EquipmentDefinitions>, I>>(
    object: I,
  ): EquipmentDefinitions {
    const message = createBaseEquipmentDefinitions();
    message.presets = Object.entries(object.presets ?? {}).reduce<{
      [key: string]: EquipmentPreset;
    }>((acc, [key, value]) => {
      if (value !== undefined) {
    ...
    message.equipments = Object.entries(object.equipments ?? {}).reduce<{
      [key: number]: Equipment;
    }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const EquipmentDefinitions_PresetsEntry: MessageFns<EquipmentDefinitions_PresetsEntry> =
  {
    encode(
      message: EquipmentDefinitions_PresetsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
    ...
    fromJSON(object: any): EquipmentDefinitions_PresetsEntry {
      return {
        key: globalThis.String(
          assertSet('EquipmentDefinitions_PresetsEntry.key', object.key),
        ),
        value: EquipmentPreset.fromJSON(
          assertSet('EquipmentDefinitions_PresetsEntry.value', object.value),
        ),
      };
    },
    ...
    fromPartial<
      I extends Exact<DeepPartial<EquipmentDefinitions_PresetsEntry>, I>,
    >(object: I): EquipmentDefinitions_PresetsEntry {
      const message = createBaseEquipmentDefinitions_PresetsEntry();
...
export const EquipmentDefinitions_EquipmentsEntry: MessageFns<EquipmentDefinitions_EquipmentsEntry> =
  {
    encode(
      message: EquipmentDefinitions_EquipmentsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== undefined) {
    ...
    fromJSON(object: any): EquipmentDefinitions_EquipmentsEntry {
      return {
        key: globalThis.Number(
          assertSet('EquipmentDefinitions_EquipmentsEntry.key', object.key),
        ),
        value: Equipment.fromJSON(
          assertSet('EquipmentDefinitions_EquipmentsEntry.value', object.value),
        ),
      };
    },
    ...
    create<
      I extends Exact<DeepPartial<EquipmentDefinitions_EquipmentsEntry>, I>,
    >(base?: I): EquipmentDefinitions_EquipmentsEntry {
      return EquipmentDefinitions_EquipmentsEntry.fromPartial(
        base ?? ({} as any),
      );
    },
    fromPartial<
      I extends Exact<DeepPartial<EquipmentDefinitions_EquipmentsEntry>, I>,
    >(object: I): EquipmentDefinitions_EquipmentsEntry {
      const message = createBaseEquipmentDefinitions_EquipmentsEntry();
...
export const Equipment: MessageFns<Equipment> = {
  ...
  fromJSON(object: any): Equipment {
    return {
      ...
      description: I18nString.fromJSON(
        assertSet('Equipment.description', object.description),
      ),
    };
  },
...
export const EquipmentPreset: MessageFns<EquipmentPreset> = {
  ...
  fromJSON(object: any): EquipmentPreset {
    return {
      slots: globalThis.Array.isArray(object?.slots)
        ? object.slots.map((e: any) => EquipmentSlot.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<EquipmentPreset>, I>>(
    base?: I,
  ): EquipmentPreset {
    return EquipmentPreset.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EquipmentPreset>, I>>(
    object: I,
  ): EquipmentPreset {
    const message = createBaseEquipmentPreset();
    message.slots =
      object.slots?.map((e) => EquipmentSlot.fromPartial(e)) || [];
    return message;
  },
};
...
export const EquipmentSlot: MessageFns<EquipmentSlot> = {
  ...
  create<I extends Exact<DeepPartial<EquipmentSlot>, I>>(
    base?: I,
  ): EquipmentSlot {
    return EquipmentSlot.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EquipmentSlot>, I>>(
    object: I,
  ): EquipmentSlot {
    const message = createBaseEquipmentSlot();
