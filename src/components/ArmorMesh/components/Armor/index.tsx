...
export const ArmorMesh = memo<ArmorMeshProps>(
  ({ thickness, maxThickness, ...props }) => {
    ...
    useEffect(() => {
      ...
      const unsubscribes = [
        ...
        useTankopediaPersistent.subscribe(
          ...
          (greenPenetration) => {
            if (material.current) {
              material.current.uniforms.greenPenetration.value =
                greenPenetration;
            }
          },
        ),
      ...
      <>
        ...
        <mesh
          ...
          onClick={async (event) => {
            ...
            const coreArmorMesh =
              intersectionsTillFirstCoreArmor.at(-1)!.object;
            const hasEnhancedArmor = await hasEquipment(110);
            ...
            if (hasRicochet) {
                ...
                .sub(
                  surfaceNormal
                    ...
                    .multiplyScalar(
                      2 *
                        surfaceNormal.dot(
                          shellNormal.clone().multiplyScalar(-1),
                        ),
                    ),
                );
              ...
              if (intersectionsTillFirstCoreArmor.length > 0) {
                ...
                ricochet = {
                  point: intersectionsTillFirstCoreArmor
                    .at(-1)!
                    .point.toArray(),
